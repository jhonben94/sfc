...
@Component({
  selector: "app-buscador-concepto-puntos",
  templateUrl: "./buscador-concepto-puntos.component.html",
  styleUrls: ["./buscador-concepto-puntos.component.css"],
})
export class BuscadorConceptoPuntosComponent implements OnInit {
  selectedRow: any;
