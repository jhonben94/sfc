...
@Component({
  selector: "app-report-uso-puntos",
  templateUrl: "./report-uso-puntos.component.html",
  styleUrls: ["./report-uso-puntos.component.css"],
})
export class ReportUsoPuntosComponent implements OnInit {
  /**
   * @type {boolean}
  ...
  buscar() {
    ...
    this.service
      .reporteUsoPuntos(this.filtrosForm.value.cantidadDias)
      .subscribe(
        (resp: any) => {
